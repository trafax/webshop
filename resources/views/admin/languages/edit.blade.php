...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Taal bewerken</li>
        </ol>
    </nav>
                ...
                <div class="tab-content col-9 ps-4" id="v-pills-tabContent">
                    ...
                    <form method="post" action="{{ route('language.update', $language) }}">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="mb-3">
                                <label>Titel</label>
                                <input type="text" name="title" class="form-control" value="{{ old('title', $language->title) }}">
                            </div>
                            <div class="mb-3">
                                <label>ISO code</label>
                                <input type="text" name="iso" class="form-control" value="{{ old('iso', $language->iso) }}">
                            </div>
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" name="default" value="1" type="checkbox" id="default" role="button" {{ $language->default == 1 ? 'checked' : '' }}>
